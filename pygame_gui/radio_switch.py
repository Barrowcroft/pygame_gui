"""
The 'radio_switch' module defines the 'RadioSwitch' class.
"""
...
class RadioSwitch(Label):
    ...
    def __init__(
        ...
        # RadioSwitches remain selected until explicitly cleared.
        ...
        # RadioSwitchstyle modifier can be DEFAULT only.
        # Alignment is one of LEFT, RIGHT, CENTER.

        self._control_type: ControlType = ControlType.RADIOSWITCH
    ...
    def handle_mouse_event(self, event_to_handle: event.Event) -> bool:
        ...
        # Since this is a RadioSwitch we also need to unselect any siblings.
        ...
        if self._parent:
            for _child in self._parent.get_children():
                if _child is not self:
                    if isinstance(_child, RadioSwitch):
